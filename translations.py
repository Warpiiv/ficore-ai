translations = {
    'English': {
        ...
        'Welcome to Ficore Africa': 'Welcome to Ficore Africa',
        'Your Financial Growth Passport': 'Your Financial Growth Passport',
        ...
        'Discover your financial personality and gain insights into your money habits.': 'Discover your financial personality and gain insights into your money habits.',
        ...
        'E.g., rent, mortgage, utilities.': 'E.g., rent, mortgage, utilities.',
        'E.g., groceries, dining out.': 'E.g., groceries, dining out.',
        'E.g., fuel, public transport, vehicle maintenance.': 'E.g., fuel, public transport, vehicle maintenance.',
        'E.g., entertainment, subscriptions, personal care.': 'E.g., entertainment, subscriptions, personal care.',
        'Start Planning Your Budget!': 'Start Planning Your Budget!',
        'Create your monthly budget now!': 'Create your monthly budget now!',
        'Receive Budgeting Tips via Email (Optional)': 'Receive Budgeting Tips via Email (Optional)',
        'Enter your total assets': 'Enter your total assets',
        'Enter your total liabilities': 'Enter your total liabilities',
        ...
        'Enter your housing expenses': 'Enter your housing expenses',
        'Enter your food expenses': 'Enter your food expenses',
        'Enter your transport expenses': 'Enter your transport expenses',
        'Enter your other expenses': 'Enter your other expenses',
    ...
    'Hausa': {
        ...
        'All the money you spend, such as on rent, food, transport, electricity bill, gas and utilities, fine and penalties, levies, taxes, etc.': 'Duk kuɗin da kake kashewa, kamar haya, abinci, sufuri,
